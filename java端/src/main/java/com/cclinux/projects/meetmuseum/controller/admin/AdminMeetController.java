...
import com.cclinux.projects.meetmuseum.service.admin.AdminMeetService;
...
@RestController("MeetMuseumAdminMeetController")
public class AdminMeetController extends BaseMyAdminController {

    @Resource(name = "MeetMuseumAdminMeetService")
