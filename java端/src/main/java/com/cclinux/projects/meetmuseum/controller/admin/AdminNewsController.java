...
import com.cclinux.projects.meetmuseum.service.admin.AdminNewsService;
...
@RestController("MeetMuseumAdminNewsController")
public class AdminNewsController extends BaseMyAdminController {

    @Resource(name = "MeetMuseumAdminNewsService")
