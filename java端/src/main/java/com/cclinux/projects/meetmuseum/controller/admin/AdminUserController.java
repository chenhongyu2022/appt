...
import com.cclinux.projects.meetmuseum.service.admin.AdminUserService;
...
@RestController("MeetMuseumAdminUserController")
public class AdminUserController extends BaseMyAdminController {

    @Resource(name = "MeetMuseumAdminUserService")
