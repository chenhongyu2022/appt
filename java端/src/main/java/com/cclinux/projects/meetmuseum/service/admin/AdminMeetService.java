package com.cclinux.projects.meetmuseum.service.admin;
...
import com.cclinux.projects.meetmuseum.comm.ProjectConfig;
...
import com.cclinux.projects.meetmuseum.service.cust.MeetService;
...
@Service("MeetMuseumAdminMeetService")
public class AdminMeetService extends BaseMyAdminService {
    ...
    @Resource(name = "MeetMuseumMeetService")
    ...
    public long insertMeet(MeetModel meet) {
        // 是否重复
        appError("{博物馆}该功能暂不开放，如有需要请加作者微信：cclinux0730");
