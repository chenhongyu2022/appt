...
-- ----------------------------
-- Table structure for meetmuseum_admin
-- ----------------------------
DROP TABLE IF EXISTS `meetmuseum_admin`;
CREATE TABLE `meetmuseum_admin`  (
...
INSERT INTO `meetmuseum_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', NULL, 1, 1, 1, 0, 0, 0);

-- ----------------------------
-- Table structure for meetmuseum_fav
-- ----------------------------
DROP TABLE IF EXISTS `meetmuseum_fav`;
CREATE TABLE `meetmuseum_fav`  (
...
-- ----------------------------
-- Table structure for meetmuseum_meet
-- ----------------------------
DROP TABLE IF EXISTS `meetmuseum_meet`;
CREATE TABLE `meetmuseum_meet`  (
...
-- ----------------------------
-- Table structure for meetmuseum_meet_join
-- ----------------------------
DROP TABLE IF EXISTS `meetmuseum_meet_join`;
CREATE TABLE `meetmuseum_meet_join`  (
...
-- ----------------------------
-- Table structure for meetmuseum_news
-- ----------------------------
DROP TABLE IF EXISTS `meetmuseum_news`;
CREATE TABLE `meetmuseum_news`  (
...
-- ----------------------------
-- Table structure for meetmuseum_setup
-- ----------------------------
DROP TABLE IF EXISTS `meetmuseum_setup`;
CREATE TABLE `meetmuseum_setup`  (
...
-- ----------------------------
-- Table structure for meetmuseum_user
-- ----------------------------
DROP TABLE IF EXISTS `meetmuseum_user`;
CREATE TABLE `meetmuseum_user`  (
